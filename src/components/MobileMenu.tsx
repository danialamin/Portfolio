  ...
  return (
    <div className={`fixed ${menuOpen ? 'top-0' : 'top-[-80vh]'} left-0 w-full h-[55vh] bg-[#080110] z-[12] transition-all duration-400 breakpoint720:hidden`}>
      <div className="flex flex-col justify-evenly items-center h-full mt-5">
        ...
        <Link href="https://github.com/danialamin/Portfolio" target="_blank"><div className="flex gap-2 items-center text-[white] text-[1.1rem]  px-2 py-2 rounded-md bg-gradient-to-r from-indigo-500 to-purple-500 hover:translate-y-[-2px] transition-all duration-100"><RiGitForkFill /><FaStar /></div></Link>
      </div>
    </div>
  )
}
